...
# tmp_par =  [.5, 1.0, 2.0]
# for tmp in tmp_par:
#     print('softmax test_error=', run_softmax_on_MNIST(temp_parameter=tmp))
# time_elapsed = time.time() - time_start
...
def PCA_run_softmax_on_MNIST(temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
...
def PCA10_run_softmax_on_MNIST(temp_parameter=1):
    """
    Trains softmax, classifies test data, computes test error, and plots cost function
    ...
    train_x = cubic_features(train_pca10)
    test_x = cubic_features(test_pca10)
